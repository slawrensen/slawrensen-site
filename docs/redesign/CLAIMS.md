...
| Key-face images are real renderer output | README "Real output only"; `scripts/contact-sheet.mjs` | Crops of `docs/assets/img/*.png` at tag v1.6.0. The values are fixed demo values typed into the contact-sheet script (56.3, 44.1, 1762, 95.4, 87, 104), **not** live readings and not the visitor's. Corrected after review: an earlier draft said they came from the author's machine. |
